...
<section class="container-fluid p-4">
    ...
    <form action="{{ isset($jardin) ? route('jardin.update', $jardin->id) : route('backend.jardin.formJardin') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 col-12 col-md-6">
            ...
            @else
                <div class="text-danger" style="display: none;">Please enter the name of the jardin.</div>
            @enderror
        </div>
        ...
        <div class="mb-3 col-12 col-md-6">
            ...
            @error('location')
                <div class="text-danger">{{ $message }}</div>
            @else
                <div class="text-danger" style="display: none;">Please enter the location of the jardin.</div>
            @enderror
        </div>
        ...
        <div class="mb-3 col-12 col-md-6">
            ...
            @error('size')
                <div class="text-danger">{{ $message }}</div>
            @else
                <div class="text-danger" style="display: none;">Please enter the size of the jardin.</div>
            @enderror
        </div>
        ...
        <div class="mb-3 col-12">
            ...
            @error('description')
                <div class="text-danger">{{ $message }}</div>
            @else
                <div class="text-danger" style="display: none;">Please provide a description of the jardin.</div>
            @enderror
        </div>
        ...
        <div class="mb-3 col-12">
            ...
            @error('image')
                <div class="text-danger">{{ $message }}</div>
            @else
                <div class="text-danger" style="display: none;">Please upload an image for the jardin.</div>
            @enderror
