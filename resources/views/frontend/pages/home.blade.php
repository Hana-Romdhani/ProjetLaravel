            ...
            <div style="background: url(../../assets/images/landing-immigration/map.svg); background-repeat: no-repeat; background-size: auto; background-position: right">
                <div class="row py-8 align-items-center gy-8">
                    <div class="col-xl-5 col-lg-5">
                        <div>
                            <span class="text-success fw-semibold">Welcome to GreenLink</span>
                            <h1 class="display-3 my-3">Empowering Your Community Garden Experience</h1>
                            <p class="mb-5 fs-3">Discover local resources and connect with fellow gardeners to cultivate your green space together.</p>
                            <a href="#" class="btn  btn-dark btn-lg">Join now</a>
                        ...
                        <div class="text-center position-relative">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute top-25 mt-4 z-1 ms-xl-n8 d-none d-md-block">
                                    <div class="bg-white border rounded-pill px-3 py-2 d-inline-block fw-medium shadow-lg">In-Person and Virtual Guidance</div>
                                </div>
                                <div class="position-absolute top-50 z-1 ms-n5 ms-xl-n8 mt-n4 d-none d-md-block">
                                    <div class="bg-white border rounded-pill px-3 py-2 d-inline-block fw-medium shadow-lg">Expert Gardeners</div>
                                </div>
                                <div class="position-absolute top-60 z-1 mt-2 ms-xl-n8 d-none d-md-block">
                                    <div class="bg-white border rounded-pill px-3 py-2 d-inline-block fw-medium shadow-lg">Recognized for Sustainable Practices</div>
                                </div>
                                <div class="position-absolute top-50 start-50 translate-middle">
                                    <div class="position-absolute top-50 start-50 translate-middle">
                                        <svg width="315" height="315" viewBox="0 0 315 315" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <clipPath id="circle">
                                                <circle cx="157.5" cy="157.5" r="154.2" />
                                            </clipPath>
                                            <image xlink:href="../../assets/images/landing-immigration/beautiful-woman-works-garden.jpg" x="0" y="0" width="315" height="315" clip-path="url(#circle)" />
                                        </svg>
                                    </div>
                                </div>
                ...
                <div class="bg-white shadow rounded-3 mt-n8 border">
                    <div class="row justify-content-around py-5 gy-4 gy-lg-0">
                        <div class="col-xl-2 col-md-4 text-center px-4">
                            ...
                            <span>Years of Gardening Expertise</span>
                        </div>
                        <div class="col-xl-2 col-md-4 text-center px-4">
                        ...
                        <div class="col-xl-2 col-md-4 text-center px-4">
                            ...
                            <span>Satisfaction with Shared Resources</span>
                        </div>
                    </div>
                </div>
            </div>
