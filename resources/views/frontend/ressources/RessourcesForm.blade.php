              ...
              <div class="card-body">
                <div class="d-lg-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center mb-4 mb-lg-0">
                    <img src="../../assets/images/avatar/images.png" id="img-uploaded" class="avatar-xl rounded-circle"
                      alt="avatar" />
                    <div class="ms-3">
                ...
                <div>
                  ...
                  <form class="row gx-3 needs-validation" novalidate>
                    ...
                    <div class="mb-3 col-12 col-md-6">
                      ...
                      <input type="text" id="profileEditFname" name="profileEditFname" class="form-control"
                    ...
                    <div class="mb-3 col-12 col-md-6">
                      ...
                      <input type="text" id="profileEditLname" name="profileEditLname" class="form-control"
                    ...
                    <div class="mb-3 col-12 col-md-6">
                      ...
                      <input type="text" id="profileEditPhone" name="profileEditPhone" class="form-control"
                    ...
                    <div class="mb-3 col-12 col-md-6">
                      ...
                      <input class="form-control flatpickr" type="text" placeholder="Birth of Date"
                        id="profileEditBirth" name="profileEditBirth" />
                      <div class="invalid-feedback">Please choose a date.</div>
                    </div>
                    <!-- Address -->
                    <div class="mb-3 col-12 col-md-6">
                      <label class="form-label" for="profileEditAddress1">Address Line 1</label>
                      <input type="text" id="profileEditAddress1" name="profileEditAddress1" class="form-control"
                    ...
                    <div class="mb-3 col-12 col-md-6">
                      ...
                      <input type="text" id="profileEditAddress2" name="profileEditAddress2" class="form-control"
                        placeholder="Address" required />
                      <div class="invalid-feedback">Please enter address.</div>
                    </div>
                    <!-- State -->
                    <div class="mb-3 col-12 col-md-6">
                      ...
                      <select class="form-select" data-choices="" id="profileEditState" name="profileEditState"
                        required>
